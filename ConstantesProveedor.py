...
constantes_proveedor = ["REGISTRAR","SALIR","CONECTAR","CREAR_CANAL","LISTAR_CANAL","BORRAR_CANAL","ENVIAR_MENSAJE_CANAL", "CREAR_TAREA", "LISTAR_TAREAS","DESCONECTAR_PROVEEDOR"]
