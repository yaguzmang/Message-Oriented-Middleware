...
constantes_proveedor = ["REGISTRAR","SALIR","CONECTAR","CREAR_CANAL","LISTAR_CANAL","BORRAR_CANAL","ENVIAR_MENSAJE_CANAL","DESCONECTAR_PROVEEDOR", "CREAR_TAREA", "LISTAR_TAREAS", "LISTAR_TAREAS_R"]
...
enviar_mensaje = "ENVIAR_MENSAJE_CANAL"
listar_tareas = "LISTAR_TAREAS"
desconectar = "DESCONECTAR_PROVEEDOR"
